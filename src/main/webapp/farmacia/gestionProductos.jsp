...
<jsp:useBean id="listaProductosBusqueda" scope="request" type="java.util.ArrayList<com.example.telefarma.beans.BProducto>"/>
...
<main>
    ...
    <div class="row justify-content-center align-items-start">
        ...
        <div class="col-md-2 text-center mt-2">
            ...
            <img class="w-100" src="${pageContext.request.contextPath}/Image?id=<%= producto.getIdProducto() %>" style="max-height: 250px; max-width: 250px">
        </div>
        <!--Precio y Stock-->
        ...
        <div class="d-flex justify-content-around align-items-center d-md-none">
            <h6 style="display: inline">
                Precio:
                <p style="display: inline;font-size: large; font-weight: normal;">&nbsp;s/ <%=producto.getPrecio()%></p>
            </h6>
            <h6 style="display: inline">
                Stock:
                <p style="display: inline;font-size: large; font-weight: normal;">&nbsp;<%=producto.getStock()%></p>
            </h6>
        </div>
        ...
        <div class="col-md-6 mt-5 d-none d-md-block">
            ...
            <h6 class="mt-1">¿Requiere Receta? <b><%=producto.getRequierePrescripcion()?"Sí":"No"%></b></h6>
        </div>
