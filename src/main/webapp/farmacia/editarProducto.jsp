                    ...
                    <div class="col-12 col-lg-9 col-xl-7">
                        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                            ...
                            <div class="card-body p-4 p-md-5">
                                <form method="POST"
                                      action="<%=request.getContextPath()%>/PharmacyServlet?action=editarProducto&&productid=<%=request.getParameter("productid")%>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <div class="form-outline mb-4">
                                                ...
                                                <input type="number" step="1" name="stock" id="productStock" class="form-control"
                                                       ...
                                                       placeholder="0" value="<%=producto.getStock()%>"/>
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-start my-3">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="requiereReceta"
                                                           ...
                                                           <%if(producto.getRequierePrescripcion()){%> checked <%}%>/>
                                        ...
                                        <div class="col-md-6 mb-4 text-center">
                                            ...
                                            <div class="text-center mt-2 mb-3">
                                                <img src="${pageContext.request.contextPath}/Image?id=<%=producto.getProductid()%>"
                                                     class="img-thumbnail" id="imagenPreview"
                                                     width="100px" height="100px" alt="imagen de producto">
                                            </div>
                                        ...
                                        <div class="col-md-12 mb-4 pb-2">
                                            <div class="form-outline">
                                                ...
                                                <textarea type="tel" id="productoDescription" name="descripcion"
                                                          class="form-control"><%=producto.getDescripcion()%></textarea>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="">
                                        <input class="btn btn-tele" type="submit" value="Guardar cambios"/>
                                    </div>
